...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, @JsonKey(name: 'photo_link') String photoLink});
}
...
class _$PhotoImpl implements _Photo {
  _$PhotoImpl({this.id, @JsonKey(name: 'photo_link') required this.photoLink});
  ...
  @override
  String toString() {
    return 'Photo(id: $id, photoLink: $photoLink)';
  }
