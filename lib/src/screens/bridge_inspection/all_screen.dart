...
@RoutePage()
class BridgeInspectionAllScreen extends ConsumerWidget {
  const BridgeInspectionAllScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(child: filteredInspectionPoints.whenOrNull(data: (points) {
      return ListView.builder(
        key: const PageStorageKey<String>('all-inspection-point-list'),
